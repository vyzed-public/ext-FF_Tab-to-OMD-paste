...
* Next, we turned the bookmarklet into an extension: [archive_ext-FF_Tab-to-OMD-paste_session-01.md](https://github.com/vyzed-public/ext-FF_Tab-to-OMD-paste/blob/main/archive/chats/archive_ext-FF_Tab-to-OMD-paste_session-01.md)
